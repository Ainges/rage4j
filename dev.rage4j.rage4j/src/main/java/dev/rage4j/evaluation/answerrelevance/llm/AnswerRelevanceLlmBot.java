...
/**
 * Judge prompts for the answer relevance metric. The question and the answer are passed in the
 * user message, never in the system message: judge models that treat the system message strictly
 * as instructions (e.g. gpt-oss, whose chat format maps it to a "developer" role) look for the
 * answer in the user turn, and when it is not there they score 0 with a reason such as "No answer
 * content was provided" — a verdict indistinguishable from a real 0. The other judge bots in this
 * module already use that layout.
 */
